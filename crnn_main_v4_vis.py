...
def val(net, val_loader, criterion, iteration, writer, max_i=1000):
    ...
    writer.add_scalar("scalar/val_loss", val_loss_avg.val(), iteration)
    writer.add_scalar("scalar/val_acc", accuracy, iteration)

    return accuracy

def train(crnn, train_loader, criterion, iteration, writer):
...
if __name__ == '__main__':
    ...
    # dataset = baiduDataset("/home/song/datasets/ocr/train_items_part_v3_p1_aa", "/home/song/datasets/ocr/all_p1_agency_addr_label.txt", params.alphabet, False, (params.imgW, params.imgH))
    # val_dataset = baiduDataset("/home/song/datasets/ocr/train_items_part_v3_p1_aa", "/home/song/datasets/ocr/val_label_p1_aa.txt", params.alphabet, False, (params.imgW, params.imgH))
